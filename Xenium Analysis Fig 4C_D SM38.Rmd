---
title: "Xenium Analysis Fig 4C_D SM38"
...
This code allows easy recreation of Figure 4D and E in SM38 (green), where we demonstrate 
...
**Xenium file name**: output-XETG00473__0049095__GOLIATH__20250221__211144


## Analysis

We start by constructing a xenium object for SM38 using seurat.

```{r, message=FALSE, warnings=FALSE}

plan("multisession", workers = 10)
path <- "~/Desktop/20250221__211124__SM41_45_SM36_294_SM56_186/output-XETG00473__0049095__GOLIATH__20250221__211144"

xenium.obj <- LoadXenium(path)

```

Outside of this code, ROIs across layers were outlined in SM38 using the lasso tool
...
data for analysis. We have established ROIs for L1, L23, L4, and L56 in SM38 and saved
those in the xenium output file. The following code will create separate xenium objects
for each layer ROI.

```{r, message=FALSE, warnings=FALSE}

L1 <- read.csv("~/Desktop/20250221__211124__SM41_45_SM36_294_SM56_186/output-XETG00473__0049095__GOLIATH__20250221__211144/Glayer1_cells_stats.csv")
L23 <- read.csv("~/Desktop/20250221__211124__SM41_45_SM36_294_SM56_186/output-XETG00473__0049095__GOLIATH__20250221__211144/Glayer23_cells_stats.csv")
L4 <- read.csv("~/Desktop/20250221__211124__SM41_45_SM36_294_SM56_186/output-XETG00473__0049095__GOLIATH__20250221__211144/Glayer4_cells_stats.csv")
L56 <- read.csv("~/Desktop/20250221__211124__SM41_45_SM36_294_SM56_186/output-XETG00473__0049095__GOLIATH__20250221__211144/Glayer56_cells_stats.csv")
...
# SM38 threshold for RMacL3_01+ classification
threshold <- 2
...
Specificity <- data.frame(
    Layer = c(1,2,4,5), 
    Specificity = c(L1specificity,L23specificity,L4specificity,L56specificity),
...
specificity. The following analysis is relevant for Figure 4E SM38 (green).
...
our error bars and running proportion tests to assess pair-wise significance between
